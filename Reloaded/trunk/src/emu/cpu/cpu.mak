...
M68KMAKE = $(BUILDOUT)/m68kmake$(CCEXE)
endif

# FIXME: if devkitpro trys to compile m68kops from the $(CPUOBJ) directory, you get hit with an avalanche of errors.
$(CPUOBJ)/m68000/m68kops.o: $(CPUOBJ)/m68000/m68kops.c | $(OSPREBUILD)
	@echo Compiling $<...
	@cp $< $(CPUSRC)/m68000
	$(CC) $(CDEFS) $(CFLAGS) -I$(CPUOBJ)/m68000 -c $(CPUSRC)/m68000/m68kops.c -o $@
	@rm $(CPUSRC)/m68000/m68kops.c
...
TMSMAKE += $(BUILDOUT)/tmsmake$(CCEXE)
endif
