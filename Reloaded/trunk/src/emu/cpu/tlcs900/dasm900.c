...
// _AND was causing a name collision somewhere, so it's been changed to _AND2
enum e_mnemonics
{
	_ADC, _ADD, _AND2, _ANDCF, _BIT, _BS1B,
...
static const tlcs900inst mnemonic_80[256] =
{
	...
	{ _AND2, _M, _I8 }, { _XOR, _M, _I8 }, { _OR, _M, _I8 }, { _CP, _M, _I8 },
	...
	/* C0 - DF */
	{ _AND2, _C8, _M }, { _AND2, _C8, _M }, { _AND2, _C8, _M }, { _AND2, _C8, _M },
	{ _AND2, _C8, _M }, { _AND2, _C8, _M }, { _AND2, _C8, _M }, { _AND2, _C8, _M },
	{ _AND2, _M, _C8 }, { _AND2, _M, _C8 }, { _AND2, _M, _C8 }, { _AND2, _M, _C8 },
	{ _AND2, _M, _C8 }, { _AND2, _M, _C8 }, { _AND2, _M, _C8 }, { _AND2, _M, _C8 },
...
static const tlcs900inst mnemonic_90[256] =
{
	...
	{ _AND2, _M, _I16 }, { _XOR, _M, _I16 }, { _OR, _M, _I16 }, { _CP, _M, _I16 },
	...
	/* C0 - DF */
	{ _AND2, _C16, _M }, { _AND2, _C16, _M }, { _AND2, _C16, _M }, { _AND2, _C16, _M },
	{ _AND2, _C16, _M }, { _AND2, _C16, _M }, { _AND2, _C16, _M }, { _AND2, _C16, _M },
	{ _AND2, _M, _C16 }, { _AND2, _M, _C16 }, { _AND2, _M, _C16 }, { _AND2, _M, _C16 },
	{ _AND2, _M, _C16 }, { _AND2, _M, _C16 }, { _AND2, _M, _C16 }, { _AND2, _M, _C16 },
...
static const tlcs900inst mnemonic_a0[256] =
{
	...
	/* C0 - DF */
	{ _AND2, _C32, _M }, { _AND2, _C32, _M }, { _AND2, _C32, _M }, { _AND2, _C32, _M },
	{ _AND2, _C32, _M }, { _AND2, _C32, _M }, { _AND2, _C32, _M }, { _AND2, _C32, _M },
	{ _AND2, _M, _C32 }, { _AND2, _M, _C32 }, { _AND2, _M, _C32 }, { _AND2, _M, _C32 },
	{ _AND2, _M, _C32 }, { _AND2, _M, _C32 }, { _AND2, _M, _C32 }, { _AND2, _M, _C32 },
...
static const tlcs900inst mnemonic_c8[256] =
{
	...
	/* C0 - DF */
	{ _AND2, _C8, _R }, { _AND2, _C8, _R }, { _AND2, _C8, _R }, { _AND2, _C8, _R },
	{ _AND2, _C8, _R }, { _AND2, _C8, _R }, { _AND2, _C8, _R }, { _AND2, _C8, _R },
	{ _ADD, _R, _I8 }, { _ADC, _R, _I8 }, { _SUB, _R, _I8 }, { _SBC, _R, _I8 },
	{ _AND2, _R, _I8 }, { _XOR, _R, _I8 }, { _OR, _R, _I8 }, { _CP, _R, _I8 },
...
static const tlcs900inst mnemonic_d8[256] =
{
	...
	/* C0 - DF */
	{ _AND2, _C16, _R }, { _AND2, _C16, _R }, { _AND2, _C16, _R }, { _AND2, _C16, _R },
	{ _AND2, _C16, _R }, { _AND2, _C16, _R }, { _AND2, _C16, _R }, { _AND2, _C16, _R },
	{ _ADD, _R, _I16 }, { _ADC, _R, _I16 }, { _SUB, _R, _I16 }, { _SBC, _R, _I16 },
	{ _AND2, _R, _I16 }, { _XOR, _R, _I16 }, { _OR, _R, _I16 }, { _CP, _R, _I16 },
...
static const tlcs900inst mnemonic_e8[256] =
{
	...
	/* C0 - DF */
	{ _AND2, _C32, _R }, { _AND2, _C32, _R }, { _AND2, _C32, _R }, { _AND2, _C32, _R },
	{ _AND2, _C32, _R }, { _AND2, _C32, _R }, { _AND2, _C32, _R }, { _AND2, _C32, _R },
	{ _ADD, _R, _I32 }, { _ADC, _R, _I32 }, { _SUB, _R, _I32 }, { _SBC, _R, _I32 },
	{ _AND2, _R, _I32 }, { _XOR, _R, _I32 }, { _OR, _R, _I32 }, { _CP, _R, _I32 },
